...
| **PP film, white, gloss, permanent** (💰 cheapest; ≈ our opaque PP) | **100×200 mm** | 1.000 | UK net | **€175,05** label-only | €228,06 incl. (label+€15 check) | included |
| PP film, white, matt, permanent | 100×200 mm | 1.000 | UK net | €289,12 label-only | €364,94 incl. (label+€15) | included |
| PP film, white, matt, removable | 100×200 mm | 1.000 | UK net | €386,18 label-only | €481,42 incl. (label+€15) | included |
| PP film, silver, permanent | 100×200 mm | 1.000 | UK net | €387,55 label-only | €483,06 incl. (label+€15) | included |
...
- **Finish + adhesive are the biggest PP price levers (confirmed, all 100×200 mm / 1.000, UK net label-only):** gloss permanent **€175,05** → matt permanent **€289,12 (+65%)** → matt removable **€386,18** → silver **€387,55**. The "💰 gloss permanent" is the budget default; matt / removable / metallic roughly **1.6–2.2×** it. (Relevant only if we ever expose finishes — keep them quote-only per §25.)
- **Full configurator captured (2026-06-03):** **printed proof is FREE/included**; paid extras = artwork check **€15** / thermal-transfer suitability **€10** / barcode verification **€25**; print colours **4-colour CMYK**; UV-varnish + protective-laminate selectors; hot-foil-stamping + tactile-warning-triangle options; **roll configuration** = "Best price" (auto labels-per-roll, outside-wound, **core 76 mm**) vs "Custom" (choose winding direction + labels/roll); production **5 business days standard** (+ ~3 working-day delivery); **delivery country + currency are selectable** (VAT follows country; the **net** figure stays comparable).
