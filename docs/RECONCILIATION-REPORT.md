...
| R-016 | `04`, `59` | Transparent PP Growth price drift: `€429` vs `€449`. | Final canonical Growth price is `€429`; `€449` is retained only as a superseded research candidate. |
| R-017 | `00`, `01`, `04`, `67-v2` | Profit framing drift around the `€100k` north-star. | `€100k` is now documented as a monthly contribution scenario, with separate interim net-profit targets. |
...
|---|---|---|---|---|
| O-001 | `04-PRICING-AND-MARGIN-MODEL.md`, `59-TOP-10-PRODUCT-PRICE-RESEARCH-GERMANY.md` | Transparent PP `2,000` package price is still not decided. | Keep the `2,000` transparent package as provisional and label it `OPEN QUESTION`; do not invent a price. | What is the final transparent PP `2,000` ex-VAT price? |
