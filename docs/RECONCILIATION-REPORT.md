...
| R-020 | `04-PRICING-AND-MARGIN-MODEL.md`, `59-...`, `00-SOURCE-OF-TRUTH.md` | Transparent PP `2,000` price was provisional / OPEN QUESTION. | Owner locked transparent PP `2,000` = `€254` (interpolated from the transparent uplift pattern). Canonical table, source-of-truth, and research doc updated. |
